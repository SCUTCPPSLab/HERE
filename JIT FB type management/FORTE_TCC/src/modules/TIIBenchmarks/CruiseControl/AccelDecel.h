...
#ifndef _ACCELDECEL_H_
#define _ACCELDECEL_H_

#include <basicfb.h>
#include <forte_int.h>

class FORTE_AccelDecel: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_AccelDecel)
...
private:
  ...
  static const TEventID scm_nEventspeedSetID = 0;
...
public:
  FORTE_AccelDecel(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_AccelDecel(){};
